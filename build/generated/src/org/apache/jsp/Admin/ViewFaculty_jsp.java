...
//
      ...
      out.write("                            <h3 class=\"block-title\">View Faculty Details</h3>\n");
      out.write("                        </div>\n");
      ...
      out.write("                                        <th>Faculty name</th> <th>Mobile no</th>\n");
      ...
      out.write("                                    ");
                                        ...
                                        ResultSet rs = DataManager.getdata("Select * from teacher");
                                        while (rs.next()) {
                                            out.println("<tr>");
                                            ...
                                            out.println("<td>");
                                            out.println("<a href='AddFaculty.jsp?did=" + rs.getString(1) + "'>Edit</a> | <a href='?did=" + rs.getString(1) + "'>Delete</a>");
                                            out.println("</td>");
