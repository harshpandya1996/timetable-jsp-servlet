...
//
      ...
      out.write("                                        <th>Subject Name</th> <th>Course name</th>\n");
      ...
      out.write("                                    ");
                                        ...
                                        ResultSet rs = DataManager.getdata("SELECT * from subject;");
                                        while (rs.next()) {
                                            out.println("<tr>");
                                            ...
                                            out.println("<td>");
                                            out.println("<a href='AddSubject.jsp?did=" + rs.getString(1) + "'>Edit</a> | <a href='../DeleteSubject?did=" + rs.getString(1) + "'>Delete</a>");
                                            out.println("</td>");
