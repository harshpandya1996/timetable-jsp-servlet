                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">View Faculty Details</h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Faculty Id</th> <th>Mobile no</th>
                                         <th>Email Id</th>
                                          <th>Action</th>
                                ...
                                <tbody>
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<td>");
                                            out.println("<a href='#" + rs.getString(1) + "'>Edit</a> | <a href='../DeleteFaculty?did=" + rs.getString(1) + "'>Delete</a>");
                                            out.println("</td>");
