                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">View Subject Details</h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Subject Name</th> <th>Course Id</th>
                                         <th>Faculty Id</th>
                                ...
                                <tbody>
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<td>");
                                            out.println("<a href=' #" + rs.getString(1) + "'>Edit</a> | <a href='../DeleteSubject?did=" + rs.getString(1) + "'>Delete</a>");
                                            out.println("</td>");
