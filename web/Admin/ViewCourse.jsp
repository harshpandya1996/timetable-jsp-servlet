                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">View Course Details</h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th> <th>Total Subject</th>
                                         <th>Action</th>
                                ...
                                <tbody>
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<td>");
                                            out.println("<a href='#" + rs.getString(1) + "'>Edit</a> | <a href='../DeleteCourse?did=" + rs.getString(1) + "'>Delete</a>");
                                            out.println("</td>");
